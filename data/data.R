...
#'
#' @format A data frame with 20,246 rows and 6 variables:
#' \describe{
#'   \item{player}{name of the baseball player}
...
#'
#' @format A data frame with 5,154 rows and 6 variables:
#' \describe{
#'   \item{player}{name of the baseball player}
#'   \item{sports}{sport that this dataset refers to}
